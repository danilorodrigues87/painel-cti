...
class Diretores extends Page{

	//RETORNA O FORMULARIO
	public static function index($request){
		//CONTEÚDO DE FORMULÁRIO
		$content = View::render('admin/modules/diretores/index',[]);
         ...
         */
		return parent::getPanel('Diretores',$content,'Parcerias');
	}
...
//DADOS DO ADMIN
    ...
    $results = EntityUser::getUser("nivel = 'Diretor' AND id_admin = 1, 'nome ASC');
    ...
    $where = "nivel = 'Diretor' AND id_admin = 1 ";
}

$itens = '<div class="row">' . $selecteCliente . '
    <div class="col">
        <button type="button" class="btn btn-success" onclick="list_itens(\'\',\'novo\')" data-toggle="modal">Cadastrar parceiro</button>
    </div>
</div>';
...
$results = EntityUser::getUser($where, 'nome ASC', $obPagination->getLimit());
    ...
    // Carrega o SELECT
		...
		<input value="' . @$dados['email_antigo'] . '" type="hidden" name="email_antigo">
